...
<div id="carouselExampleInterval" class="carousel slide inner-css" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="5000">
      <img src="img/banner1.webp" class="d-block w-100" alt="..." width="100%" height="100%">
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <a href="openai.php"><img src="img/ai-banner2.webp" class="d-block w-100" alt="..." width="100%" height="100%"></a>
    </div>
    <div class="carousel-item">
      <img src="img/banner1.webp" class="d-block w-100" alt="..." width="100%" height="100%">
    </div>
  </div>
  <button class="carousel-control-prev" type="button" data-bs-target="coming_soon.htmlcarouselExampleInterval" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="coming_soon.htmlcarouselExampleInterval" data-bs-slide="next">
...
<!--area tag for ai banner Section start-->
<!-- <map name="aibanner">
  <area shape="rect" coords="2077,2419,2953,1953" href="openai.php" alt="">
</map> -->
<!--area tag for ai banner Section start-->
...
<!-- <div class="form">
    <div class="searchbar">
      <input class="search_input" type="text" name="" placeholder="Search here...">
        <a href="coming_soon.html" class="search_icon"><i class="fa fa-search" aria-hidden="true"></i></a>
    </div>
  </div> -->
<!-- Courses Heading End -->

<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6521349394702804" crossorigin="anonymous"></script>
<!-- Ad for header -->
<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-6521349394702804" data-ad-slot="3555489595" data-ad-format="auto" data-full-width-responsive="true"></ins>
<script>
