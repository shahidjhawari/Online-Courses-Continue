...
<div class="domain tag-heading">
    <div class="titlepage text_align_center">
        <h2>DD TAG <span class="blue_light">EXAMPLE</span></h2>
    </div>
</div>
<!-- all course add heading start -->
    ...
    <div id="carouselExample" class="carousel slide inner-css">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/dd-tag.png" class="d-block w-100" alt="dd tag html">
            </div>
        </div>
    </div>
</div>
<div class="container d-flex align-items-center justify-content-center download-btn">
    <a href="img/dd-tag.png" download="dd tag - NAWAB ACADEMY" class="btn btn-danger">Download</a>
</div>
<!--Tag Section End-->
