...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
      <div class="container-fluid">
        <a href="index.php"><img src="img/logo_bg_remove.webp" alt="NAWAB LOGO" title="NAWAB ACADEMY - Jhawarian, Sargodha, Punjab, Pakistan" width="50px"></a>
  ...
  <marquee id="news" behavior="" scrollamount="13">CLASSES START FROM 1 MAY 2024 - ONLY FOR STUDENTS OF JHAWARIAN - WEB DEVELOPMENT & WEB DESIGNING COURSES - ADMISSION NOW</marquee>
  <!--Header Section End-->